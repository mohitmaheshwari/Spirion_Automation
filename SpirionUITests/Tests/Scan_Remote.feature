Feature: ScanTests_Remote
	Tests containing all scanning on Remote
...
Scenario Outline: Given User is trying to scan Single SSN File
	...
	Examples:
		...
		| SSN Shred_AUID | Do not delete or update this PlayBook | User Action  | Shred         | Automation Logic | Data Types | Contains        | Social Security Number | SDM SD Remote SSN Shred_AUID: | This scan is developed by automation | Files & Folders | Remote Target  | Custom Folder List | \SensitiveDataScan\Shred | TestData\TestData.csv |
...
Scenario Outline: Given User is trying to scan Mut SSN File
	...
	Examples:
		| PlayBookName          | PlayBookDescription                   | LeftDecision   | RightDecision  | LogicName        | LogicType  | LogicTypeOption | ScanItem                                                   | ScanName                             | ScanDescription                      | ScanType        | ScanTargetType | ScanLocationType   | FolderPath                                  | TestFile              |
		| Mutiple Classify_AUID | Do not delete or update this PlayBook | Take No Action | Classification | Automation Logic | Data Types | Contains        | Social Security Number;Telephone Number;Credit Card Number | SDM SD Remote Mutiple Classify_AUID: | This scan is developed by automation | Files & Folders | Remote Target  | Custom Folder List | \SensitiveDataScan\ClassifyMultipleDataType | TestData\TestData.csv |
...
Scenario Outline: Given User is trying to scan SSN for Redact resolution
	...
	Examples:
		| PlayBookName | PlayBookDescription                   | LeftDecision   | RightDecision | LogicName        | LogicType  | LogicTypeOption | ScanItem               | ScanName                   | ScanDescription                      | ScanType        | ScanTargetType | ScanLocationType   | FolderPath                | TestFile              |
		| Redact_AUID  | Do not delete or update this PlayBook | Classification | Redact        | Automation Logic | Data Types | Contains        | Social Security Number | SDM SD Remote Redact_AUID: | This scan is developed by automation | Files & Folders | Remote Target  | Custom Folder List | \SensitiveDataScan\Redact | TestData\TestData.csv |
...
Scenario Outline: Given User is trying to scan SSN for quartine resolution
	...
	Examples:
		...
		| Quarantine_AUID | Do not delete or update this PlayBook | Classification | Quarantine    | Automation Logic | Data Types | Contains        | Social Security Number | SDM SD Remote Quarantine_AUID: | This scan is developed by automation | Files & Folders | Remote Target  | Custom Folder List | \SensitiveDataScan\Quarantine | TestData\TestData.csv | The original file, {0}, contained unsecured, personally identifiable information.  It has been auto-quarantined (via workflow) to: |
...
Scenario Outline: Given User is trying to scan SSN for Execute Script resolution
	...
	Examples:
		| PlayBookName        | PlayBookDescription                   | LeftDecision   | RightDecision  | LogicName        | LogicType  | LogicTypeOption | ScanItem               | ScanName                          | ScanDescription                      | ScanType        | ScanTargetType | ScanLocationType   | FolderPath                       | TestFile              |
		| ExecuteScripts_AUID | Do not delete or update this PlayBook | Classification | Execute Script | Automation Logic | Data Types | Contains        | Social Security Number | SDM SD Remote ExecuteScript_AUID: | This scan is developed by automation | Files & Folders | Remote Target  | Custom Folder List | \SensitiveDataScan\ExecuteScript | TestData\TestData.csv |
...
Scenario Outline: Given User is trying to scan SSN for Notify resolution
	...
	Examples:
		| PlayBookName | PlayBookDescription                   | LeftDecision   | RightDecision | LogicName        | LogicType  | LogicTypeOption | ScanItem               | ScanName                   | ScanDescription                      | ScanType        | ScanTargetType | ScanLocationType   | FolderPath                       | TestFile              |
		| Notify_AUID  | Do not delete or update this PlayBook | Classification | Notify        | Automation Logic | Data Types | Contains        | Social Security Number | SDM SD Remote Notify_AUID: | This scan is developed by automation | Files & Folders | Remote Target  | Custom Folder List | \SensitiveDataScan\ExecuteScript | TestData\TestData.csv |
...
Scenario Outline: Given User is trying to scan SSN for User Action resolution
	...
	Examples:
		| PlayBookName    | PlayBookDescription                   | LeftDecision   | RightDecision | LogicName        | LogicType  | LogicTypeOption | ScanItem               | ScanName                       | ScanDescription                      | ScanType        | ScanTargetType | ScanLocationType   | FolderPath                    | TestFile              |
		| UserAction_AUID | Do not delete or update this PlayBook | Classification | User Action   | Automation Logic | Data Types | Contains        | Social Security Number | SDM SD Remote UserAction_AUID: | This scan is developed by automation | Files & Folders | Remote Target  | Custom Folder List | \SensitiveDataScan\UserAction | TestData\TestData.csv |
...
Scenario Outline: Given User is trying to scan SSN for Assign resolution Role
	...
	Examples:
		| PlayBookName    | PlayBookDescription                   | LeftDecision   | RightDecision | LogicName        | LogicType  | LogicTypeOption | ScanItem               | ScanName                       | ScanDescription                      | ScanType        | ScanTargetType | ScanLocationType   | FolderPath                    | TestFile              |
		| AssignRole_AUID | Do not delete or update this PlayBook | Classification | Assign_Role   | Automation Logic | Data Types | Contains        | Social Security Number | SDM SD Remote AssignRole_AUID: | This scan is developed by automation | Files & Folders | Remote Target  | Custom Folder List | \SensitiveDataScan\AssignRole | TestData\TestData.csv |
...
Scenario Outline: Given User is trying to scan SSN for Assign resolution User
	...
	Examples:
		| PlayBookName    | PlayBookDescription                   | LeftDecision   | RightDecision | LogicName        | LogicType  | LogicTypeOption | ScanItem               | ScanName                       | ScanDescription                      | ScanType        | ScanTargetType | ScanLocationType   | FolderPath                    | TestFile              |
		| AssignUser_AUID | Do not delete or update this PlayBook | Classification | Assign_User   | Automation Logic | Data Types | Contains        | Social Security Number | SDM SD Remote AssignUser_AUID: | This scan is developed by automation | Files & Folders | Remote Target  | Custom Folder List | \SensitiveDataScan\AssignUser | TestData\TestData.csv |
...
Scenario Outline: Given User is trying to scan SSN for Take No Action resolution
	...
	Examples:
		| PlayBookName      | PlayBookDescription                   | LeftDecision   | RightDecision  | LogicName        | LogicType  | LogicTypeOption | ScanItem               | ScanName                         | ScanDescription                      | ScanType        | ScanTargetType | ScanLocationType   | FolderPath                      | TestFile              |
		| TakeNoAction_AUID | Do not delete or update this PlayBook | Classification | Take No Action | Automation Logic | Data Types | Contains        | Social Security Number | SDM SD Remote TakeNoAction_AUID: | This scan is developed by automation | Files & Folders | Remote Target  | Custom Folder List | \SensitiveDataScan\TakeNoAction | TestData\TestData.csv |
...
Scenario Outline: Given User is trying to scan SSN for Ignore resolution
	...
	Examples:
		| PlayBookName | PlayBookDescription                   | LeftDecision   | RightDecision | LogicName        | LogicType  | LogicTypeOption | ScanItem               | ScanName                   | ScanDescription                      | ScanType        | ScanTargetType | ScanLocationType   | FolderPath                | TestFile              |
		| Ignore_AUID  | Do not delete or update this PlayBook | Classification | Ignore        | Automation Logic | Data Types | Contains        | Social Security Number | SDM SD Remote Ignore_AUID: | This scan is developed by automation | Files & Folders | Remote Target  | Custom Folder List | \SensitiveDataScan\Ignore | TestData\TestData.csv |
